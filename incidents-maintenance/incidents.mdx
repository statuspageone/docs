...
<Card title="Create Incident Updates" icon="message" href="/incidents-maintenance/incident-updates">
...
<CardGroup cols={2}>
  ...
  <Card title="Scheduled Maintenance" icon="wrench" href="/incidents-maintenance/maintenance">
