...
<CardGroup cols={2}>
  <Card title="Customize Appearance" icon="palette" href="/docs/status-pages/custom-domains">
  ...
  <Card title="Create Monitors" icon="plus-circle" href="/docs/monitoring/creating-monitors">
